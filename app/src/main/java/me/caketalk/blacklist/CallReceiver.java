...
public class CallReceiver extends BroadcastReceiver {
    ...
    public CallReceiver(Object telephony, Context ctx) throws NoSuchMethodException {
        this.telephony = telephony;
        this.endCall = telephony.getClass().getDeclaredMethod("endCall");
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("android.intent.action.PHONE_STATE".equals(action)) { // Intercepts phone call
            ...
            if (blockOptId != -1 && blockOptId != 1) {
                ...
                Log.d(this.getClass().getName(), String.format("Receiving SMS is blocked => { From: %s, SMS Body: %s }", smsFrom, smsBody));
            }
